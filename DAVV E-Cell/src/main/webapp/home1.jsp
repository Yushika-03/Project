...
<header class="sticky">
    <div class="logo-container">
        <img id="img" src="Image/E-Cell DAVV Logo white.png" alt="Logo">
    </div>
...
<div  class="cards-section">
    <div class="card">
        <h2>Vision</h2><br>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Hic quod fuga asperiores explicabo dolorem, praesentium corporis, illum inventore voluptatibus, voluptas temporibus laudantium cumque facere. Iure eligendi similique obcaecati harum vero. </p>
    </div>
    <div class="card">
        <h2>Moto</h2><br>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis incidunt ipsum voluptatibus repellendus fuga perspiciatis recusandae accusamus reprehenderit expedita? Minus, voluptatum repudiandae sit similique excepturi aliquid quae error numquam impedit!</p>
    </div>
</div>
